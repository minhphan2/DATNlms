...
public ResponseEntity<List<CourseResponse>> getCoursesByDepartmentId(@PathVariable Integer id) {
    List<CourseResponse> courseResponses = courseService.getCourseByDepartmentId(id);
